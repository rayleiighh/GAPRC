        ...
        <div style={{ padding: "0 28px", display: "flex", flexDirection: "column", gap: 20 }}>
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <input value={prenom} onChange={(e) => setPrenom(e.target.value)} placeholder="Prénom" style={{ ...inputBase, borderColor: err("client") ? "#fca5a5" : "#e5e7eb", boxShadow: err("client") ? "0 0 0 3px rgba(220,38,38,0.1)" : "none" }} onFocus={(e) => { e.currentTarget.style.borderColor = "#dc2626"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(220,38,38,0.1)"; }} onBlur={(e) => { e.currentTarget.style.borderColor = err("client") ? "#fca5a5" : "#e5e7eb"; e.currentTarget.style.boxShadow = "none"; }} />
              <input value={nom} onChange={(e) => setNom(e.target.value)} placeholder="Nom" style={{ ...inputBase, borderColor: err("client") ? "#fca5a5" : "#e5e7eb", boxShadow: err("client") ? "0 0 0 3px rgba(220,38,38,0.1)" : "none" }} onFocus={(e) => { e.currentTarget.style.borderColor = "#dc2626"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(220,38,38,0.1)"; }} onBlur={(e) => { e.currentTarget.style.borderColor = err("client") ? "#fca5a5" : "#e5e7eb"; e.currentTarget.style.boxShadow = "none"; }} />
            </div>
          </div>
          <div>
            ...
            <input value={sport} onChange={(e) => setSport(e.target.value)} placeholder="ex: Tennis, Badminton, Football..." style={{ ...inputBase, borderColor: err("sport") ? "#fca5a5" : "#e5e7eb", boxShadow: err("sport") ? "0 0 0 3px rgba(220,38,38,0.1)" : "none" }} onFocus={(e) => { e.currentTarget.style.borderColor = "#dc2626"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(220,38,38,0.1)"; }} onBlur={(e) => { e.currentTarget.style.borderColor = err("sport") ? "#fca5a5" : "#e5e7eb"; e.currentTarget.style.boxShadow = "none"; }} />
          </div>
          <div>
            <label style={{ fontSize: "0.72rem", fontWeight: 700, color: err("heures") ? "#dc2626" : "#6b7280", textTransform: "uppercase", letterSpacing: "0.07em", display: "block", marginBottom: 10 }}>Durée *</label>
            <input value={heures} onChange={(e) => setHeures(e.target.value)} placeholder="ex: 1h, 1h30, 2h15..." style={{ ...inputBase, borderColor: err("heures") ? "#fca5a5" : "#e5e7eb", boxShadow: err("heures") ? "0 0 0 3px rgba(220,38,38,0.1)" : "none" }} onFocus={(e) => { e.currentTarget.style.borderColor = "#dc2626"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(220,38,38,0.1)"; }} onBlur={(e) => { e.currentTarget.style.borderColor = err("heures") ? "#fca5a5" : "#e5e7eb"; e.currentTarget.style.boxShadow = "none"; }} />
          </div>
          <div>
            <label style={{ fontSize: "0.72rem", fontWeight: 700, color: err("montant") ? "#dc2626" : "#6b7280", textTransform: "uppercase", letterSpacing: "0.07em", display: "block", marginBottom: 10 }}>Montant * <span style={{ fontWeight: 400, textTransform: "none", letterSpacing: 0 }}>(au moins un montant requis)</span></label>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          ...
          {errors.length > 0 && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 14px", background: "#fef2f2", borderRadius: 10, border: "1px solid #fecaca" }}>
              <AlertCircle style={{ width: 15, height: 15, color: "#dc2626", flexShrink: 0 }} /><span style={{ fontSize: "0.82rem", color: "#b91c1c", fontWeight: 500 }}>Veuillez remplir tous les champs obligatoires (*)</span>
            </div>
          )}
